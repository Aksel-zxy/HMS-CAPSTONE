...
if ( $_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = $patientObj->updatePatient($patient_id, $updatedData);
        ...
        if($result){
             header("location:../Patient Management/outpatient.php");
             exit;    
        } else {
    ...
    <div class="container">
        ...
        <form method="post">
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="fname" value="<?= $patient['fname']; ?>" required minlenght="2">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="lname" value="<?= $patient['lname']; ?>" required minlenght="2">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="age" class="form-control" id="age" name="age" value="<?= $patient['age']; ?>" readonly>
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="tel" class="form-control" name="phone_number" value="<?= $patient['phone_number']; ?>" required maxlength="11">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <select class="form-select" name="admission_type" required>
                        ...
                        <option value="Planned"<?=($patient['admission_type'] == 'Planned') ? 'selected': ''; ?>>Planned</option>
                        <option value="Elective"<?=($patient['admission_type'] == 'Elective') ? 'selected': ''; ?>>Elective</option>
                        <option value="Day Case"<?=($patient['admission_type'] == 'Day Case') ? 'selected': ''; ?>>Day Case</option>
                        <option value="Maternity"<?=($patient['admission_type'] == 'Maternity') ? 'selected': ''; ?>>Maternity</option>
                        <option value="Outpatient"<?=($patient['admission_type'] == 'Outpatient') ? 'selected': ''; ?>>Outpatient</option>
                        <option value="Observation"<?=($patient['admission_type'] == 'Observation') ? 'selected': ''; ?>>Observation</option>
                    </select>
                </div>
            </div>
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="number" class="form-control" name="bed_number" value="<?= $patient['bed_number']; ?>">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary" href="../Patient Management/outpatient.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>
