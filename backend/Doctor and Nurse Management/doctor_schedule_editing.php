...
$doctors = [];
$doctor_query = "SELECT employee_id, first_name, middle_name, last_name, role, profession, department FROM hr_employees WHERE profession = 'Doctor'";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_schedule'])) {
    ...
    header("Location: doctor_schedule_editing.php?view_sched_id=" . urlencode($employee_id));
    exit();
}
...
<body>
    ...
    <h2 class="mb-4">Doctors Schedule Editing</h2>
    ...
    <!-- Doctors List Table -->
    <div class="card mb-4">
        <div class="card-header bg-primary text-white">Doctors List</div>
        <div class="card-body">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="doctor_schedule_editing.php" class="btn-close"></a>
                </div>
                ...
                <div class="modal-footer">
                    <a href="doctor_schedule_editing.php" class="btn btn-secondary">Close</a>
                </div>
            </div>
        </div>
    </div>
