...
<li class="sidebar-item">
        ...
        <div class="main">
            ...
            <div class="container-fluid calendar-container">
                <h2 class="mb-4 text-primary fw-bold">Doctors Schedule Editing</h2>
                <a href="doctor_shift_scheduling.php" class="btn btn-info mb-3">Back</a>
                ...
                <div class="card shadow-sm rounded mb-4">
                    <div class="card-header bg-primary text-white doctors-list-header">Doctors List</div>
