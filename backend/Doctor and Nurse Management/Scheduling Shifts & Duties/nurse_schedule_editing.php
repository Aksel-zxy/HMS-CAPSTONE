...
// Fetch all nurses with details and active clinical status
$nurses = [];
$nurse_query = "
...
<li class="sidebar-item">
        ...
        <div class="main">
            ...
            <div class="container-fluid calendar-container">
                <h2 class="mb-4 text-primary fw-bold">Nurses Schedule Editing</h2>
                <a href="nurse_shift_scheduling.php" class="btn btn-info mb-3">Back</a>
                ...
                <div class="card shadow-sm rounded mb-4">
                    <div class="card-header bg-primary text-white nurses-list-header">Nurses List</div>
