        ...
        <table class="table table-bordered table-hover">
            ...
            <div class="container-fluid">
                <div class="title-container">
                    <h2  style="font-family:Arial, sans-serif; color:#0d6efd; margin-bottom:20px; border-bottom:2px solid #0d6efd; padding-bottom:8px;">💊Add Prescription</h2>
                </div>
                            ...
                            <div class="modal-content">
                                ...
                                <form action="process_prescription.php" method="POST">
                                    <div class="modal-body">
                                        ...
                                        <input type="hidden" name="doctor_id" value="<?= htmlspecialchars($_SESSION['employee_id']) ?>">
                                        <div class="mb-3">
