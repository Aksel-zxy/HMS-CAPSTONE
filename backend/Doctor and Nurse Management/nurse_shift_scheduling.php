...
class NurseShiftScheduling {
    ...
    private function fetchNurses() {
        $nurse_query = "SELECT employee_id, first_name, last_name FROM hr_employees WHERE profession = 'Nurse'";
...
<body>
    ...
    <h2 class="mb-4">Nurse Shift Scheduling</h2>
    ...
    <form method="POST">
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-3">
                ...
                <a href="nurse_schedule_editing.php" class="btn btn-info">
                    Nurse Schedule Editing
                </a>
            </div>
        </div>
