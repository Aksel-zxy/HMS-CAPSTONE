      ...
      <ul>
        ...
        <li>
          ...
          <div class="dropdown-container" style="<?= $isStockActive ? 'display:block;' : 'display:none;' ?>">
            <a href="inventory-stock" class="<?= $currentPage=='inventory-stock'?'active-link':'' ?>">Inventory & Stock Tracking</a>
            <a href="batch-expiry" class="<?= $currentPage=='batch-expiry'?'active-link':'' ?>">Batch & Expiry Tracking</a>
        ...
        <li>
          ...
          <div class="dropdown-container" style="<?= $isVendorActive ? 'display:block;' : 'display:none;' ?>">
            <a href="vendor-application" class="<?= $currentPage=='vendor-application'?'active-link':'' ?>">Vendor Registration Approval</a>
            <a href="vendor-list" class="<?= $currentPage=='vendor-list'?'active-link':'' ?>">Vendors</a>
            <a href="vendor-rating" class="<?= $currentPage=='vendor-rating'?'active-link':'' ?>">Vendor Rating & Feedback</a>
        ...
        <li>
          ...
          <div class="dropdown-container" style="<?= $isPOActive ? 'display:block;' : 'display:none;' ?>">
            <a href="purchase-order" class="<?= $currentPage=='purchase-order'?'active-link':'' ?>">Purchase Order</a>
            <a href="purchase-request" class="<?= $currentPage=='purchase-request'?'active-link':'' ?>">Purchase Request</a>
            <a href="order-receive" class="<?= $currentPage=='order-receive'?'active-link':'' ?>">Goods Receipt & Verification</a>
            <a href="po-status" class="<?= $currentPage=='po-status'?'active-link':'' ?>">PO Status Tracking</a>
          </div>
        </li>
