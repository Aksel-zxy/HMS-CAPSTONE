...
<body>
    <div class="d-flex">
        ...
        <aside id="sidebar" class="sidebar-toggle">
            ...
            <div class="menu-title">Pharmacy Management | Sales</div>
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <link rel="stylesheet" href="med_inventory.css">
</head>
<body>

  <div class="main-content">
    <div class="top-bar">
      <div class="user-name">Welcome, Staff</div>
    </div>

    <div class="dashboard-content">
      <h2>Pharmacy Sales</h2>
      <button class="add-btn" onclick="openModal()">+ Add Sale</button>
  ...
  <!-- Modal -->
  <div class="modal hidden" id="salesModal">
    <div class="modal-content">
      <span class="close-btn" onclick="closeModal()">&times;</span>
      <h3 id="modalTitle">Add Sale</h3>
      <form id="salesForm">
        <label for="salesId">Sales ID</label>
        <input type="text" id="salesId" required>
        ...
        <input type="number" id="quantitySold" step="0.01" required>
    ...
    <script src="assets/Bootstrap/sales.js"></script>
</body>
