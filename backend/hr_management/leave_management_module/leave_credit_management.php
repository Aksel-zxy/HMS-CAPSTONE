...
require_once 'classes/LeaveCredit.php';
...
<head>
    ...
    <link rel="stylesheet" href="css/leave_credit_management.css">
...
<body>
            ...
            <div class="summary">
                ...
                <div id="popupForm" class="popup-form">
                    <div class="form-container">
                        ...
                        <center>
                            <h3 style="font-weight: bold;">Add Leave Credit</h3> 
                        </center>

                        <form action="process_leave_credit.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <?php $employees = $leaveCreditModel->getAllEmployees(); ?>
                            ...
                            <div class="form-group">
                                <button type="submit">Save Leave Credits</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <table id="CreditsTable">
                    ...
                    <tbody>
                        <?php if ($leaveCredits && is_array($leaveCredits) && count($leaveCredits) > 0): ?>
                            <?php 
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="7">No leave data found.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const maternityField = document.getElementById("maternity_leave_field");
            const paternityField = document.getElementById("paternity_leave_field");

            function toggleLeaveFields() {
                const selected = employeeSelect.options[employeeSelect.selectedIndex];
                const gender = selected ? selected.getAttribute("data-gender") : "";

                if (gender === "Female") {
                    maternityField.style.display = "block";
                    paternityField.style.display = "none";
                } else if (gender === "Male") {
                    maternityField.style.display = "none";
                    paternityField.style.display = "block";
                } else {
                    maternityField.style.display = "none";
                    paternityField.style.display = "none";
                }
            ...
            employeeSelect.addEventListener("change", toggleLeaveFields);
