...
require_once 'classes/LeaveApproval.php';
...
<body>
    ...
    <div class="d-flex">
        ...
        <div class="main">
            ...
            <div class="employees">
                <p style="text-align: center; font-size: 35px; font-weight: bold; padding-bottom: 20px; color: #0047ab;">Leave Applications for Approval</p>
