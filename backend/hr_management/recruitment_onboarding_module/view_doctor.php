            ...
            <div class="form-container">
                ...
                <form action="update_doctor.php" method="post" enctype="multipart/form-data">
                    ...
                    <select id="department" name="department" required>
                        <?php 
                        $departments = [
                            'Anesthesiology & Pain Management','Cardiology (Heart & Vascular System)','Dermatology (Skin, Hair, & Nails)',
                            'Ear, Nose, and Throat (ENT)','Emergency Department (ER)','Gastroenterology (Digestive System & Liver)',
                    ...
                    <select id="employment_type" name="employment_type" required>
                        <?php 
                        $employment_types = ['Full-Time','Part-Time','Contractual','Consultant'];
                    ...
                    <select id="educational_status" name="educational_status" required>
                        <?php 
                        $edu_status = ['Graduate','Post Graduate'];
                    ...
                    <select id="degree_type" name="degree_type" required>
                        <?php 
                        $degrees = ['Doctor of Medicine (MD)','Post Graduate Internship'];
                        foreach ($degrees as $deg) : ?>
                            <option value="<?= $deg ?>" <?= ($employee['degree_type'] ?? '') == $deg ? 'selected' : '' ?>><?= $deg ?></option>
                        <?php endforeach; ?>
                    </select>
