...
$doctorObj = new Doctor($conn);
$employee = $doctorObj->getByEmployeeId($employeeId);

if (!$employee) {
    die("Employee not found.");
}

$documentsResult = $doctorObj->getEmployeeDocuments($employeeId);
...
$photoSrc = isset($uploadedDocs[$docType]) && !empty($uploadedDocs[$docType])
    ? str_replace(' ', '%20', $uploadedDocs[$docType]) // handle spaces
        ...
        <div class="employee-container">
            <div class="employee-card">
                ...
                <div class="topbars">
                    ...
                    <div class="link-bar">
                        <a href="list_of_doctors.php" style="color:black;">
        ...
        <div id="editModal" class="popup-form">
            <div class="form-container">
                ...
                <form action="update_doctor.php" method="post" enctype="multipart/form-data">
                    ...
                    <option value="Doctor" <?= ($employee['profession'] == 'Doctor') ? 'selected' : ''; ?>>Doctor</option>
                    </select>

                    <label for="role">Role:</label>
                    <select id="role" name="role" required>
                        <option value="Resident Doctor" <?= $employee['role'] == 'Resident Doctor' ? 'selected' : '' ?>>Resident Doctor</option>
                        <option value="Chief Resident" <?= $employee['role'] == 'Chief Resident' ? 'selected' : '' ?>>Chief Resident</option>
                        <option value="Attending Physician/Consultant" <?= $employee['role'] == 'Attending Physician/Consultant' ? 'selected' : '' ?>>Attending Physician/Consultant</option>
                        <option value="Department Chairperson/Head of Department" <?= $employee['role'] == 'Department Chairperson/Head of Department' ? 'selected' : '' ?>>Department Chairperson/Head of Department</option>
                        <option value="Hospital Director/Chief Medical Officer" <?= $employee['role'] == 'Hospital Director/Chief Medical Officer' ? 'selected' : '' ?>>Hospital Director/Chief Medical Officer</option>
                    </select>
                    ...
                    <select id="degree_type" name="degree_type" required>
                        <option value="Doctor of Medicine (MD)" <?= ($employee['degree_type'] == 'Doctor of Medicine (MD)') ? 'selected' : ''; ?>>Doctor of Medicine (MD)</option>
                        <option value="Post Graduate Internship" <?= ($employee['degree_type'] == 'Post Graduate Internship') ? 'selected' : ''; ?>>Post Graduate Internship</option>
                    </select>
