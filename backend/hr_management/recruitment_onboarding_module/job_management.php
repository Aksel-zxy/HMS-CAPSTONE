...
require_once 'classes/JobManager.php';
require_once 'classes/ReplacementRequest.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $result = $jobManager->addJob($_POST, $_FILES['image']);
    if ($result === true) {
...
if (isset($_GET['job_id'])) {
    if ($jobManager->deleteJob(intval($_GET['job_id']))) {
        ...
        <div class="main">
            ...
            <div id="popupForm" class="popup-form">
                <div class="form-container">
                    ...
                    <center>
                        <h3 style="font-weight: bold;">Post a Job</h3> 
                    </center>
