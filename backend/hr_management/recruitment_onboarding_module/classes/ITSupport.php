...
class ITSupport {
    ...
    public function getITSupports($search = '', $status = '') {
        $sql = "SELECT * FROM hr_employees WHERE profession = 'IT Support'";
        $conditions = [];
        $params = [];
        $types = '';
    ...
    public function addITSupport($data) {
    ...
    public function getByEmployeeId($employeeId) {
        $stmt = $this->conn->prepare("SELECT * FROM hr_employees WHERE employee_id = ? AND profession = 'IT Support' LIMIT 1");
