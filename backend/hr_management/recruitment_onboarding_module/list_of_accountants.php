...
<body>
    ...
    <div class="main">
        ...
        <!-- ----- Table ----- -->
        <div class="employees">
            <p style="text-align: center;font-size: 35px;font-weight: bold;padding-bottom: 20px;color: #0047ab;">Accountants List</p>
            <table id="AccountantsTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <center>
                                <a href="view_accountant.php?employee_id=<?= htmlspecialchars($row['employee_id'] ?? '') ?>" class="view-link">
                                    View Details
                                </a>
                            </center>
                        </td>
