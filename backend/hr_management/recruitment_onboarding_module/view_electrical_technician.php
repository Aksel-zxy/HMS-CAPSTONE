...
$electricalObj = new ElectricalTechnician($conn);
$employee = $electricalObj->getByEmployeeId($employeeId);
...
$documentsResult = $electricalObj->getEmployeeDocuments($employeeId);
    ...
    <div class="main">
        ...
        <div class="employee-container">
            <div class="employee-card">
                ...
                <div class="topbars">
                    ...
                    <div class="link-bar">
                        <a href="list_of_electrical_technicians.php" style="color:black;">
        ...
        <div id="editModal" class="popup-form">
            <div class="form-container">
                ...
                <form action="update_electrical_technician.php" method="post" enctype="multipart/form-data">
                    ...
                    <select id="profession" name="profession" required>
                        <option value="Electrical Technician" <?= ($employee['profession'] ?? '') == 'Electrical Technician' ? 'selected' : '' ?>>Electrical Technician</option>
                    </select>
                    ...
                    <select id="educational_status" name="educational_status" required>
                        <?php 
                        $edu_status = ['Vocational Graduate','College Level','College GraduateCollege Level'];
                    ...
                    <label>Vocational Diploma or Certificate:</label>
