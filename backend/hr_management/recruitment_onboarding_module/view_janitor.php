...
$janitorObj = new Janitor($conn);
$employee = $janitorObj->getByEmployeeId($employeeId);
...
$documentsResult = $janitorObj->getEmployeeDocuments($employeeId);
    ...
    <div class="main">
        ...
        <div class="employee-container">
            <div class="employee-card">
                ...
                <div class="topbars">
                    ...
                    <div class="link-bar">
                        <a href="list_of_janitors.php" style="color:black;">
        ...
        <div id="editModal" class="popup-form">
            <div class="form-container">
                ...
                <form action="update_janitor.php" method="post" enctype="multipart/form-data">
                    ...
                    <select id="profession" name="profession" required>
                        <option value="Janitor" <?= ($employee['profession'] ?? '') == 'Janitor' ? 'selected' : '' ?>>Janitor</option>
                    </select>
