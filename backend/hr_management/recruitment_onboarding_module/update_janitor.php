...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($updateSuccess) {
        echo "<script>alert('Janitor and documents updated successfully!'); window.location.href = 'view_janitor.php?employee_id=$employeeId';</script>";
    } else {
        echo "<script>alert('Error updating Janitor. Please try again.'); window.history.back();</script>";
    }
}
