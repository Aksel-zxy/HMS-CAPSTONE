...
$search = $_GET['search'] ?? '';
$status = $_GET['status'] ?? '';
$doctors = $doctor->getDoctors($search, $status);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($doctor->addDoctor($data)) {
        ...
        echo "<script>alert('Doctor registered successfully!'); window.location='list_of_doctors.php';</script>";
    } else {
    ...
    <div class="main">
        ...
        <div class="topbars">
            ...
            <div class="search-bar">
                <form method="GET" action="list_of_doctors.php">
        ...
        <!-- ----- Add Doctors ----- -->
        <center>
            <button class="hahaha" onclick="openForm()">Add Doctor</button>
        </center>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a href="view_doctor.php?employee_id=<?= htmlspecialchars($row['employee_id']); ?>" class="view-link">View Details</a>
                                </center>
                            </td>
                        </tr>
                    <?php endwhile; 
        ...
        <!-- ----- Pop-Up Form (Add Doctors) ----- -->
        <div id="popupForm" class="popup-form">
            <div class="form-container">
                <bttn class="close-btn" onclick="closeForm()">X</bttn>
                <center>
                    <h3 style="font-weight: bold;">Add Doctor</h3> 
                </center>
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <label for="username"><span style="color: red;font-weight: bold;font-size: 15px;">*</span>Username: &nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red;font-weight: bold;">(d + Employee ID)</span></label>
                    ...
                    <select id="role" name="role" required>
                        ...
                        <option value="Department Chairperson/Head of Department">Department Chairperson/Head of Department</option>
                        <option value="Hospital Director/Chief Medical Officer">Hospital Director/Chief Medical Officer</option>
                    </select>
                    <br />
                    ...
                    <select id="department" name="department" required>
                        ...
                        <option value="Internal Medicine (General & Subspecialties)">Internal Medicine (General & Subspecialties)</option>
                        <option value="Nephrology (Kidneys & Dialysis)">Nephrology (Kidneys & Dialysis)</option>
                        
                        <option value="Neurology & Neurosurgery (Brain & Nervous System)">Neurology & Neurosurgery (Brain & Nervous System)</option>
                        ...
                        <option value="Orthopedics (Bones, Joints, and Muscles)">Orthopedics (Bones, Joints, and Muscles)</option>
                        <option value="Pediatrics (Child Healthcare)">Pediatrics (Child Healthcare)</option>
                        <option value="Psychiatry & Mental Health">Psychiatry & Mental Health</option>
                        <option value="Pulmonology (Lungs & Respiratory System)">Pulmonology (Lungs & Respiratory System)</option>
                        <option value="Rehabilitation & Physical Therapy">Rehabilitation & Physical Therapy</option>
                        <option value="Surgery (General & Subspecialties)">Surgery (General & Subspecialties)</option>
                    </select>
                    <br />

                    <label for="specialization"><span style="color: red; font-weight: bold; font-size: 15px;">*</span>Specialization:</label>
                    ...
                    <option value="Post Graduate Internship">Post Graduate Internship</option>
                    </select>
                    <br />
    ...
    <script>
        ...
        function updateUsername() {
            ...
            if (/^\d{3}$/.test(employeeId)) {
                usernameField.value = "d" + employeeId;
            } else {
                usernameField.value = "";
            }
        }
        ...
        document.getElementById('employee_id').addEventListener('input', function() {
            let employee_id = this.value.trim();
            if (employee_id.length >= 3) {
                fetch('check_availability.php?type=employee_id&value=' + encodeURIComponent(employee_id))
                .then(res => res.json())
                .then(data => {
                    if (data.exists) {
