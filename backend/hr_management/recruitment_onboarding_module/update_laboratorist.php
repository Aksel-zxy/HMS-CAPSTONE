...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$employee) {
        echo "<script>alert('Laboratorist not found.'); window.history.back();</script>";
        exit;
    }
    ...
    if ($updateSuccess) {
        echo "<script>alert('Laboratorist and documents updated successfully!'); window.location.href = 'view_laboratorist.php?employee_id=$employeeId';</script>";
    } else {
        echo "<script>alert('Error updating laboratorist. Please try again.'); window.history.back();</script>";
    }
}
