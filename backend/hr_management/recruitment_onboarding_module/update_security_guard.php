...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($updateSuccess) {
        echo "<script>alert('Security Guard and documents updated successfully!'); window.location.href = 'view_security_guard.php?employee_id=$employeeId';</script>";
    } else {
        echo "<script>alert('Error updating Security Guard. Please try again.'); window.history.back();</script>";
    }
}
