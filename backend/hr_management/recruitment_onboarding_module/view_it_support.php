...
$itsupportObj = new ITSupport($conn);
$employee = $itsupportObj->getByEmployeeId($employeeId);
...
$documentsResult = $itsupportObj->getEmployeeDocuments($employeeId);
    ...
    <div class="main">
        ...
        <div class="employee-container">
            <div class="employee-card">
                ...
                <div class="topbars">
                    ...
                    <div class="link-bar">
                        <a href="list_of_it_support.php" style="color:black;">
        ...
        <div id="editModal" class="popup-form">
            <div class="form-container">
                ...
                <form action="update_it_support.php" method="post" enctype="multipart/form-data">
                    ...
                    <select id="profession" name="profession" required>
                        <option value="IT Support" <?= ($employee['profession'] ?? '') == 'IT Support' ? 'selected' : '' ?>>IT Support</option>
                    </select>
