...
<body>
    ...
    <div class="main">
        ...
        <!-- ----- Table ----- -->
        <div class="employees">
            <p style="text-align: center;font-size: 35px;font-weight: bold;padding-bottom: 20px;color: #0047ab;">Nurses List</p>
            <table id="NursesTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <center>
                                <a href="view_nurse.php?employee_id=<?= htmlspecialchars($row['employee_id'] ?? '') ?>" class="view-link">
                                    View Details
                                </a>
                            </center>
                        </td>
