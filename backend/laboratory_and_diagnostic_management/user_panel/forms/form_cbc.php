...
$machineQuery = $conn->query("SELECT machine_id, machine_name, machine_type FROM machine_equipments WHERE status = 'Available' AND (machine_name LIKE '%CBC%' OR machine_name LIKE '%Hematology%' OR machine_name LIKE '%Analyzer%' OR machine_name LIKE '%Microscope%' OR machine_name LIKE '%Centrifuge%') ORDER BY machine_name ASC");
$machineItems = [];
if ($machineQuery) {
