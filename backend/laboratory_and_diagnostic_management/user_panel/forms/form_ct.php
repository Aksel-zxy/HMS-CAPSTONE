...
$machineQuery = $conn->query("SELECT machine_id, machine_name, machine_type FROM machine_equipments WHERE status = 'Available' AND (machine_name LIKE '%CT %' OR machine_name LIKE '%CT Scanner%') ORDER BY machine_name ASC");
$machineItems = [];
if ($machineQuery) {
