...
$machineQuery = $conn->query("SELECT machine_id, machine_name, machine_type FROM machine_equipments WHERE status = 'Available' AND machine_name LIKE '%MRI%' ORDER BY machine_name ASC");
$machineItems = [];
if ($machineQuery) {
...
<body class="container mt-4">
    ...
    <form method="POST" action="forms/results.php" enctype="multipart/form-data">
        <input type="hidden" name="testType" value="MRI">
        ...
        <div class="mb-3">
            ...
            <input type="file" class="form-control" name="mri_image" accept="image/*">
        </div>
