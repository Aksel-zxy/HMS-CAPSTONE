...
// Fetch Doctors
$query = "SELECT e.employee_id, e.first_name, e.last_name, e.role FROM hr_employees e 
          WHERE e.role IN ('Non-Resident Doctor', 'Resident Doctor', 'Chief Resident')";
                    ...
                    ?>
                        <div class="col-md-4 mb-4 doctor-card" data-name="<?php echo strtolower($doc['first_name'] . ' ' . $doc['last_name']); ?>">
                            <div class="card shadow-sm h-100 text-center p-3" style="border-radius:15px; border:none;">
                                ...
                                <h5 class="mb-0">Dr. <?php echo htmlspecialchars($doc['first_name'] . " " . $doc['last_name']); ?></h5>
                                <p class="text-muted small"><?php echo $doc['role']; ?></p>
