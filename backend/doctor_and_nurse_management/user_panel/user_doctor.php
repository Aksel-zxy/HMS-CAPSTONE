    ...
    <div class="d-flex">
        ...
        <aside id="sidebar" class="sidebar-toggle">
            ...
            <li class="sidebar-item">
                <a href="Doctor/my_doctor_schedule.php" class="sidebar-link" data-bs-toggle="#" data-bs-target="#"
             ...
             <li class="sidebar-item">
                <a href="Doctor/doctor_duty.php" class="sidebar-link" data-bs-toggle="#" data-bs-target="#"
                    aria-expanded="false" aria-controls="auth">
