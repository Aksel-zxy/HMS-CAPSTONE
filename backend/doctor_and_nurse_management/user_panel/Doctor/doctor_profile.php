                        ...
                        <div class="card-body p-4">
                            <div class="row">
                                <div class="col-md-6 border-end">
                                    <h6 class="text-primary fw-bold text-uppercase small mb-3">Professional Details</h6>
                                    <div class="mb-3"><label class="small text-muted fw-bold">Department</label>
                                        <div><?= htmlspecialchars($m_emp['department']) ?></div>
                                    </div>
                                    <div class="mb-3"><label class="small text-muted fw-bold">Specialization</label>
                                        <div><?= htmlspecialchars($m_emp['specialization']) ?></div>
                                    </div>
                                    <div class="mb-3"><label class="small text-muted fw-bold">Email</label>
                                        <div><?= htmlspecialchars($m_emp['email'] ?? 'Not set') ?></div>
                                    </div>
                                </div>
                                <div class="col-md-6 ps-md-4">
                                    <h6 class="text-primary fw-bold text-uppercase small mb-3">Clinical Settings</h6>
                                    <div class="mb-3"><label class="small text-muted fw-bold">Clinical Status</label>
                                        <div><?= htmlspecialchars($m_prof['clinical_status'] ?? 'Not Registered') ?></div>
                                    </div>
                                    <div class="mb-3"><label class="small text-muted fw-bold">Preferred Shift</label>
                                        <div><?= htmlspecialchars($m_prof['preferred_shift'] ?? '-') ?></div>
                                    </div>
                                    <div class="mb-3"><label class="small text-muted fw-bold">Max Hours/Week</label>
