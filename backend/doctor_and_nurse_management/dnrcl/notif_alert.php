...
// Urgent List (Fetches top 5 urgent items)
$urgent_sql = "SELECT 
...
// ==========================================
// 2. NOTIFICATION ALERTS LOGIC (Popups)
// ==========================================
$alerts = [];
// Fetch EXPIRED Licenses
$sql_expired = "SELECT 
    first_name, last_name, 'Professional License' as type, license_expiry as date,
    DATEDIFF(license_expiry, CURDATE()) as days
    FROM hr_employees 
    WHERE profession IN ('Doctor', 'Nurse') 
...
$result_warning = $conn->query($sql_warning);
if ($result_warning) {
...
<body>
    <div class="d-flex">
        <aside id="sidebar" class="sidebar-toggle">
            ...
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#schedule" aria-expanded="true">
                ...
                <ul id="schedule" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a href="../scheduling_shifts_and_duties/doctor_shift_scheduling.php" class="sidebar-link">Doctor Shift Scheduling</a></li>
                    <li class="sidebar-item"><a href="../scheduling_shifts_and_duties/nurse_shift_scheduling.php" class="sidebar-link">Nurse Shift Scheduling</a></li>
                    <li class="sidebar-item"><a href="../scheduling_shifts_and_duties/duty_assignment.php" class="sidebar-link">Duty Assignment</a></li>
                    <li class="sidebar-item"><a href="../scheduling_shifts_and_duties/schedule_calendar.php" class="sidebar-link">Schedule Calendar</a></li>
                </ul>
            </li>

            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#license" aria-expanded="true">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cast" viewBox="0 0 640 640">
                ...
                <ul id="license" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a href="registration_clinical_profile.php" class="sidebar-link">Registration & Clinical Profile Management</a></li>
                    <li class="sidebar-item"><a href="license_management.php" class="sidebar-link">License Management</a></li>
                    <li class="sidebar-item"><a href="compliance.php" class="sidebar-link">Compliance Monitoring Dashboard</a></li>
                    <li class="sidebar-item"><a href="notif_alert.php" class="sidebar-link">Notifications & Alerts</a></li>
                    <li class="sidebar-item"><a href="audit_log.php" class="sidebar-link">Compliance Audit Log</a></li>
                </ul>
            </li>

            <li class="sidebar-item">
                <a href="doctor_dashboard.php" class="sidebar-link" data-bs-toggle="#" data-bs-target="#" aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cast" viewBox="0 0 640 640">
        ...
        <div class="main">
            ...
            <div class="container-fluid py-4">
                <h2 style="font-family:Arial, sans-serif; color:#0d6efd; margin-bottom:20px; border-bottom:2px solid #0d6efd; padding-bottom:8px;">🔔 Notification Alert</h2>

                <div class="row">
                    <div class="col">
                        <div class="card shadow-sm border-0 h-100">
                            <div class="card-header text-blue py-3">
                                <h5 class="mb-0 fw-bold"><i class="bi bi-bell-fill me-2"></i>Urgent Action Required</h5>
                            </div>
                                        ...
                                        <tbody>
                                            <?php if ($urgent_docs->num_rows > 0): ?>
                                                <?php while ($row = $urgent_docs->fetch_assoc()):
                                                    ...
                                                    // Dot Logic
                                                    $dotClass = $is_expired ? 'dot-red' : 'dot-yellow';
                                                    $statusText = $is_expired ? 'Expired' : $days . ' Days Left';
                                                    $textClass = $is_expired ? 'text-danger fw-bold' : 'text-dark';
                                                ?>
                                                    <tr>
                                                        <td class="ps-3 fw-bold text-dark">
                                                            <?= htmlspecialchars($row['first_name'] . ' ' . $row['last_name']) ?>
                                                        </td>
                                                        <td class="small text-muted"><?= htmlspecialchars($row['profession']) ?></td>
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="3" class="text-center py-4 text-muted small">
                                                        <i class="bi bi-check-circle fs-5 d-block mb-1 text-success"></i>
                                                        No urgent issues.
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
