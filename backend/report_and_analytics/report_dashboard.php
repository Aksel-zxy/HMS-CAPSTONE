    ...
    <div class="d-flex">
        ...
        <aside id="sidebar" class="sidebar-toggle">
            ...
            <li class="sidebar-item">
                <a href="admin_dashboard.php" class="sidebar-link" aria-expanded="false">
            ...
            <li class="sidebar-item">
                <a href="#" class="sidebar-link collapsed has-dropdown" data-bs-toggle="collapse" data-bs-target="#staffMgmt" aria-expanded="true" aria-controls="staffMgmt">
