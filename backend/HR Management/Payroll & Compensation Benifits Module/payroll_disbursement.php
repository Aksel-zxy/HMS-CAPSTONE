        ...
        <aside id="sidebar" class="sidebar-toggle">
            ...
            <li class="sidebar-item">
                ...
                <ul id="geraldddd" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                    ...
                    <li class="sidebar-item">
                        <a href="computation_benifits.php" class="sidebar-link">Compensation & Benifits</a>
                    </li>
                    <li class="sidebar-item">
                        <a href="payslip_generation.php" class="sidebar-link">Payslip Generation</a>
                    </li>
                    <li class="sidebar-item">
                        <a href="payroll_disbursement.php" class="sidebar-link">Payroll Disbursement</a>
                    </li>
                    <li class="sidebar-item">
