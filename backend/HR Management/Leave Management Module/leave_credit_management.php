                ...
                <table id="CreditsTable">
                    <thead>
                        <tr>
                            ...
                            <th>Rejected</th>
                            <th>Pending</th>
                            <th>Days on Approved Leave</th>
                            <th>Yearly Leave Credits</th>
                            <th>Remaining Leave Credits</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php if ($leaveCredits && $leaveCredits->num_rows > 0): ?>
                            <?php while ($row = $leaveCredits->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><?= $row['rejected_leaves'] ?></td>
                                <td><?= $row['pending_leaves'] ?></td>
                                <td><?= $row['total_approved_leave_days'] ?></td>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="11">No leave data found.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
