...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Fetch employee details from hr_employees
    $empQuery = $conn->prepare("SELECT first_name, last_name, profession, role, department FROM hr_employees WHERE employee_id = ?");
    $empQuery->bind_param("s", $employee_id);
    $empQuery->execute();
    ...
    $profession = $empRow['profession'];
    $role = $empRow['role'];
    $department = $empRow['department'];

    // Optional medical cert upload
    $medical_cert = null;
    if (isset($_FILES['medical_cert']) && $_FILES['medical_cert']['error'] === UPLOAD_ERR_OK) {
        $upload_dir = 'uploads/medical_certs/';
        if (!is_dir($upload_dir)) {
            mkdir($upload_dir, 0777, true);
        }

        $file_tmp = $_FILES['medical_cert']['tmp_name'];
        $file_name = uniqid() . '_' . basename($_FILES['medical_cert']['name']);
        $file_path = $upload_dir . $file_name;

        if (move_uploaded_file($file_tmp, $file_path)) {
            $medical_cert = $file_path;
        }
    }

    $stmt = $conn->prepare("INSERT INTO hr_leave 
...
<body>
    <div class="d-flex">
        ...
        <aside id="sidebar" class="sidebar-toggle">
            ...
            <li class="sidebar-item">
                ...
                <ul id="geralddd" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                    ...
                    <li class="sidebar-item">
                        <a href="leave_approval.php" class="sidebar-link">Leave Approval</a>
                    </li>
                    <li class="sidebar-item">
        ...
        <div class="main">
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= htmlspecialchars($emp['profession']) ?></td>
            ...
            <div class="modal fade" id="leaveModal" tabindex="-1" aria-labelledby="leaveModalLabel" aria-hidden="true"  data-bs-backdrop="false">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="employee_profession" disabled>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="employee_department" disabled>
                            </div>
    ...
    <script>
        ...
        function fillLeaveForm(id, firstName, lastName, profession, role, department) {
