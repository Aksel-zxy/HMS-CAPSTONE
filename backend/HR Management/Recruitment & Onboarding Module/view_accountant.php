...
require 'classes/Accountant.php';
...
$accountantObj = new Accountant($conn);
$employee = $accountantObj->getByEmployeeId($employeeId);

if (!$employee) {
    die("Employee not found.");
}

$documentsResult = $accountantObj->getEmployeeDocuments($employeeId);
        ...
        <div class="employee-container">
            <div class="employee-card">
                ...
                <div class="topbars">
                    ...
                    <div class="link-bar">
                        <a href="list_of_accountants.php" style="color:black;">
        ...
        <div id="editModal" class="popup-form">
            <div class="form-container">
                ...
                <form action="update_accountant.php" method="post" enctype="multipart/form-data">
                    ...
                    <option value="Accountant" <?= ($employee['profession'] == 'Accountant') ? 'selected' : ''; ?>>Accountant</option>
                    </select>

                    <label for="department">Department:</label>
                    <select id="department" name="department" required>
                        <option value="Billing" <?= $employee['department'] == 'Billing' ? 'selected' : '' ?>>Billing</option>
                        <option value="Insurance" <?= $employee['department'] == 'Insurance' ? 'selected' : '' ?>>Insurance</option>
                        <option value="Expenses" <?= $employee['department'] == 'Expenses' ? 'selected' : '' ?>>Expenses</option>
                    </select>
                    ...
                    <select id="degree_type" name="degree_type" required>
                        <option value="Bachelor of Science in Accountancy (BSA)" <?= ($employee['degree_type'] == 'Bachelor of Science in Accountancy (BSA)') ? 'selected' : ''; ?>>Bachelor of Science in Accountancy (BSA)</option>
                        <option value="Bachelor of Science in Accounting Information System (BSAIS)" <?= ($employee['degree_type'] == 'Bachelor of Science in Accounting Information System (BSAIS)') ? 'selected' : ''; ?>>Bachelor of Science in Accounting Information System (BSAIS)</option>
                        <option value="Bachelor of Science in Management Accounting (BSMA)" <?= ($employee['degree_type'] == 'achelor of Science in Management Accounting (BSMA)') ? 'selected' : ''; ?>>Bachelor of Science in Management Accounting (BSMA)</option>
                        <option value="Bachelor of Science in Internal Auditing" <?= ($employee['degree_type'] == '') ? 'selected' : 'Bachelor of Science in Internal Auditing'; ?>>Bachelor of Science in Internal Auditing</option>
                        <option value="Bachelor of Science in Business Administration Major in Financial Management (BSBA-FM)" <?= ($employee['degree_type'] == 'Bachelor of Science in Business Administration Major in Financial Management (BSBA-FM)') ? 'selected' : ''; ?>>Bachelor of Science in Business Administration Major in Financial Management (BSBA-FM)</option>
                    </select>
