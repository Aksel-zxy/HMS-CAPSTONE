...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$employee) {
        echo "<script>alert('Pharmacist not found.'); window.history.back();</script>";
        exit;
    }
    ...
    if ($updateSuccess) {
        echo "<script>alert('Pharmacist and documents updated successfully!'); window.location.href = 'view_pharmacist.php?employee_id=$employeeId';</script>";
    } else {
        echo "<script>alert('Error updating pharmacist. Please try again.'); window.history.back();</script>";
    }
}
