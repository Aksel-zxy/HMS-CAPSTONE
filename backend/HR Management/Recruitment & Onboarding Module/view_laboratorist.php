...
require 'classes/Laboratorist.php';
            ...
            <div class="form-container">
                ...
                <form action="update_laboratorist.php" method="post" enctype="multipart/form-data">
                    ...
                    <select id="department" name="department" required>
                        <option value="Clinical Chemistry" <?= ($employee['department'] == 'Clinical Chemistry') ? 'selected' : ''; ?>>Clinical Chemistry</option>
                        <option value="Hematology" <?= ($employee['department'] == 'Hematology') ? 'selected' : ''; ?>>Hematology</option>
                        <option value="Microbiology" <?= ($employee['department'] == 'Microbiology') ? 'selected' : ''; ?>>Microbiology</option>
                        <option value="Parasitology" <?= ($employee['department'] == 'Parasitology') ? 'selected' : ''; ?>>Parasitology</option>
                        <option value="Blood Bank / Immunohematology" <?= ($employee['department'] == 'Blood Bank / Immunohematology') ? 'selected' : ''; ?>>Blood Bank / Immunohematology</option>
                        <option value="Immunology / Serology" <?= ($employee['department'] == 'Immunology / Serology') ? 'selected' : ''; ?>>Immunology / Serology</option>
                        <option value="Histopathology" <?= ($employee['department'] == 'Histopathology') ? 'selected' : ''; ?>>Histopathology</option>
                    </select>
